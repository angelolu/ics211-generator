        ...
        <table className="w-full table-fixed border-collapse border-2 border-black text-xs print:text-[10px]">
          ...
          <thead className="table-header-group">
              ...
              <td colSpan={7 + extraColsCount} className="p-0 border-0">
                <div className="grid grid-cols-4 border-b-2 border-black">
                  <div className="col-span-1 border-r border-black p-2 flex flex-col justify-center items-center min-w-0">
                    <h1 className="font-bold text-lg leading-tight uppercase text-center">Incident Check In List</h1>
                    <h2 className="font-bold text-[10px] uppercase text-center">(Single/Team/Equip)</h2>
                  </div>
                  ...
                  <div className="col-span-1 px-1 py-0.5 min-w-0 overflow-hidden">
                    <div className="text-[10px] uppercase font-semibold leading-tight">3. {typeLabel} NUMBER</div>
                ...
                <div className="grid grid-cols-4">
                  ...
                  <div className="col-span-1 border-r border-black px-1 py-0.5 min-w-0 overflow-hidden">
                    <div className="text-[10px] uppercase font-semibold leading-tight">5. LIAISON NAME</div>
                  ...
                  <div className="col-span-1 border-r border-black px-1 py-0.5 min-w-0 overflow-hidden">
                    <div className="text-[10px] uppercase font-semibold leading-tight">6. AGENCY ADDRESS</div>
                  ...
                  <div className="col-span-1 px-1 py-0.5 min-w-0 overflow-hidden">
                    <div className="text-[10px] uppercase font-semibold leading-tight">7. AGENCY PHONE #</div>
            ...
            <tr className="bg-gray-50/50 border-y-2 border-black">
              ...
              <th className="border-r border-black py-1 px-2 text-[10px] font-semibold text-center uppercase leading-tight">AGENCY/<br />TEAM</th>
              <th className="border-r border-black py-1 px-2 text-[10px] font-semibold text-center uppercase leading-tight">TIME<br />IN</th>
              <th className="border-r border-black py-1 px-2 text-[10px] font-semibold text-center uppercase leading-tight">TIME<br />OUT</th>
            ...
            {formState.rows.map((row) => {
              ...
              return (
                <tr key={row.id} className={rowClasses}>
                  ...
                  <td className="border-r border-black p-1 px-2">
                    <EditableCell rowActions={rowActions} onContextMenuEvent={handleCellContextMenu} cell={row.cells.agencyTeam} onChange={(v) => onUpdateRow(row.id, 'agencyTeam', v)} highlightChanges={highlightChanges} className="break-words" />
                  </td>
                  <td className="border-r border-black p-1 text-center">
              ...
              <td colSpan={7 + extraColsCount} className="p-0 border-0">
                <div className="grid grid-cols-4 border-t-2 border-black mt-0">
                  ...
                  <div className="col-span-3 px-1 py-0.5 pl-4 overflow-hidden">
                    <div className="text-[10px] uppercase font-semibold leading-tight">5. PREPARED BY (RESOURCE UNIT)</div>
...
ICS211BForm.displayName = 'ICS211BForm';
